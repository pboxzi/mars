    ...
    <div className="space-y-5" data-testid="payment-settings">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-stone-600">
          Update one payment method at a time. The fan preview stays simple below.
        </p>
      </div>

      <section className="rounded-[24px] border border-stone-200 bg-white p-4 sm:p-5">
        <p className="text-sm font-semibold text-stone-500">Choose Method</p>
      ...
      <section className="rounded-[24px] border border-stone-200 bg-white p-4 sm:p-5">
        ...
        <p className="mt-1 text-sm text-stone-500">
          This is the simple instruction your guest will receive for {activeMethod.label.toLowerCase()}.
        </p>
